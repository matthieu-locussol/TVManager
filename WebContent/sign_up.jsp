	...
	<div class="login-wrapper">
	   	<form action="http://localhost:8080/TVManager/TVManager" method="POST" role="form">
			<div class="popup-header">
				<span class="text-semibold">Sign up</span>
			</div>
			<div class="well">
				...
				<div class="form-group has-feedback">
					...
					<input type="text" class="form-control" placeholder="Username" name="pseudonyme">
					<i class="icon-users form-control-feedback"></i>
				</div>
	
				<div class="row form-actions">
					<div class="col-xs-6">
						<button type="submit" class="btn btn-primary left">Sign up</button>
					</div>
					<div class="col-xs-6">
						<a href="login.jsp" class="btn btn-link pull-right"><i class="icon-user"></i> Already registered ?</a>
					</div>
				</div>
			</div>
	   	</form>
